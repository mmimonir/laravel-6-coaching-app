            ...
            <form action="{{ route('update-slide') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="table-responsive p-1">
                    <table id="" class="table table-bordered dt-responsive nowrap text-center" style="width: 100%;">
                        <tr>
                            <td><img src="{{ asset('/').$slide->slide_image }}" alt="" id="slide_show"
                            ...
                            <td>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="slide_image" id="slideImage"
                                            onchange="showImage(this, 'slide_show')">
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                            ...
                                            name="slide_title" id="slideTitle" placeholder="Write slide title here"
                                            required value="{{$slide->slide_title}}">
                                        @error('slide_title')
                                ...
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                            ...
                                            value="{{$slide->slide_description}}" required>
